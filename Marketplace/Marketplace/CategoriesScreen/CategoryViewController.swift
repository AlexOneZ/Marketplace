...
class CategoryViewController: UIViewController {
    let categories: [CategoryCell] = [
        CategoryCell(
            ...
            jsonRequest: "men's%20clothing"
        ),
        CategoryCell(
            iconCategory: "👚",
            description: "Women's clothes",
            jsonRequest: "women's%20clothing"
        ),
        CategoryCell(
            iconCategory: "🖥",
            description: "Electronics",
            jsonRequest: "electronics"
        ),
        CategoryCell(
            iconCategory: "💎",
            description: "Jeweliry",
            jsonRequest: "jewelery"
        )
    ]
...
extension CategoryViewController: UICollectionViewDelegate {
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        categoryProductViewController.productDownload(
            urlString: "https://fakestoreapi.com/products/category/\(viewModel.jsonRequest)")
